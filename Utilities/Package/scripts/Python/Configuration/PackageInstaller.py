...
packages = [
    ...
    ('lxml', 'Web Scraping', 'Processes XML and HTML', 'lxml'),
    ('html5lib', 'Web Scraping', 'Parses HTML', 'html5lib'),
    ('scrapy', 'Web Scraping', 'Web crawling framework', 'Scrapy'),
    ('selenium', 'Web Automation', 'Web browser automation tool', 'Selenium'),
    ('tqdm', 'Utilities', 'Progress bar library', 'tqdm'),
    ('PyPDF2', 'File Processing', 'PDF manipulation and extraction', 'PyPDF2'),
    ('boto3', 'Cloud Services', 'AWS SDK for Python', 'Boto3'),
    ('awswrangler', 'Cloud Services', 'Python library for AWS data', 'AWS Wrangler'),
    ('azure-servicebus', 'Cloud Services', 'Azure messaging service', 'Azure Service Bus'),
    ('simple-salesforce', 'Cloud Services', 'Python wrapper for Salesforce API', 'Simple Salesforce'),
    ('pandas', 'Data Manipulation', 'Data manipulation and analysis tool', 'Pandas'),
    ('numpy', 'Data Manipulation', 'Fundamental package for numerical computation', 'NumPy'),
    ('pyarrow', 'Data Manipulation', 'Columnar data and in-memory analytics', 'PyArrow'),
    ('pympler', 'Data Manipulation', 'Memory profiling for Python applications', 'Pympler'),
    ('fuzzywuzzy', 'Data Matching', 'String matching and comparison', 'FuzzyWuzzy'),
    ('recordlinkage', 'Data Matching', 'Link and match records', 'Record Linkage Toolkit'),
    ('strsimpy', 'Data Matching', 'String Similarity Algorithms: Similarity metrics', 'Strsimpy'),
    ('textdistance', 'Data Matching', 'Compute distances between texts', 'TextDistance'),
    ('chart-studio', 'Data Visualization', 'Create interactive charts', 'Chart Studio'),
    ('matplotlib', 'Data Visualization', 'Plotting library', 'Matplotlib'),
    ('seaborn', 'Data Visualization', 'Statistical data visualization', 'Seaborn'),
    ('plotly', 'Data Visualization', 'Interactive graphing library', 'Plotly'),
    ('bokeh', 'Data Visualization', 'Interactive visualization library', 'Bokeh'),
    ('dash', 'Data Visualization', 'Interactive web applications for visualization', 'Dash'),
    ('IPython', 'Development', 'Interactive Python shell', 'IPython'),
    ('virtualenv', 'Development', 'Tool to create isolated Python environments', 'Virtualenv'),
    ('python3-devel', 'Development', 'Essential libraries for development', 'Python3 Devel'),
    ('pip', 'Development', 'Package installer for Python', 'Pip'),
    ('setuptools', 'Development', 'Library for Python packaging', 'Setuptools'),
    ('pytest', 'Development', 'Testing framework for Python', 'pytest'),
    ('s3fs', 'File Systems', 'File system for Amazon S3', 'S3FS'),
    ('fsspec', 'File Systems', 'Filesystem specification for data handling', 'FSSpec'),
    ('paramiko', 'File Systems', 'SSH2 protocol for remote server management', 'Paramiko'),
    ('pysftp', 'File Systems', 'Simple SFTP interface', 'PySFTP'),
    ('openpyxl', 'File Handling', 'Read/write Excel files', 'Openpyxl'),
    ('pillow', 'Image Processing', 'Image processing library', 'Pillow'),
    ('opencv-python', 'Image Processing', 'Computer vision and machine learning library', 'OpenCV'),
    ('country_converter', 'Localization', 'ISO 3166 data conversions', 'Country Converter'),
    ('phonenumbers', 'Localization', 'Parse, format, and validate phone numbers', 'Phonenumbers'),
    ('uszipcode', 'Localization', 'Get U.S. zipcode data', 'US Zipcode'),
    ('pyzipcode', 'Localization', 'Search U.S. zipcode database', 'Pyzipcode'),
    ('us', 'Localization', 'US state and territory metadata', 'US'),
    ('sqlalchemy', 'Database', 'SQL toolkit and ORM library', 'SQLAlchemy'),
    ('pymongo', 'Database', 'MongoDB driver', 'PyMongo'),
    ('trino', 'Database', 'Distributed SQL query engine', 'Trino'),
    ('pyathena', 'Database', 'Athena client for AWS', 'PyAthena'),
    ('presto-python-client', 'Database', 'Python client for Presto', 'Presto Client'),
    ('requests', 'Networking', 'Simplifies making HTTP requests', 'Requests'),
    ('socket', 'Networking', 'Provides low-level networking interfaces', 'Socket'),
    ('websocket-client', 'Networking', 'WebSocket API for Python', 'WebSocket Client'),
    ('requests_oauthlib', 'Networking', 'OAuth for HTTP requests', 'Requests OAuthlib'),
    ('scipy', 'Data Science', 'Scientific and technical computing', 'SciPy'),
    ('statsmodels', 'Data Science', 'Statistical models', 'Statsmodels'),
    ('xgboost', 'Machine Learning', 'Gradient boosting library', 'XGBoost'),
    ('lightgbm', 'Machine Learning', 'Fast gradient boosting library', 'LightGBM'),
    ('scikit-learn', 'Machine Learning', 'Machine learning library', 'Scikit-learn'),
    ('tensorflow', 'Machine Learning', 'Open-source platform for machine learning', 'TensorFlow'),
    ('keras', 'Machine Learning', 'High-level neural networks API', 'Keras'),
    ('shap', 'Machine Learning', 'Interpret ML model predictions', 'SHAP'),
    ('pytorch', 'Machine Learning', 'Deep learning framework', 'PyTorch')
]
